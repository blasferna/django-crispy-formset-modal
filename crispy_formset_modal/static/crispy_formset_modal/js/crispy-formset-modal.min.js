...
`};class O{constructor(t){this._id=t,this.targetEl=document.getElementById(this._id),this.variant=_.tabular,this.$formset=null,this._options={...D},this._modalForms=[],this._deleteBt=null,this._table=null,this._tbody=null,this._tfoot=null,this._init(),this._addEvents()}_init(){this.variant=this._getVariant(),this.templatePack=this._getTemplatePack(),this.modalSize=this._getModalSize(),this.modalPlacement=this._getModalPlacement(),this.$formset=n(`#${this._id}`),this.$formset.formset({animateForms:!0}),(this.variant===_.modal||this.variant==_.tabular)&&(this._table=this.targetEl.querySelector("table"),this._tbody=this._table.querySelector("tbody"),this._tfoot=this._table.querySelector("tfoot"),this._emptyState=this._tbody.innerHTML),this.variant===_.modal&&(this._deleteBt=this.targetEl.querySelector(".delete-selected"),this._checkInitials(),this._configureSelectAllToggler(),this._refresh())}_getVariant(){return this.targetEl.getAttribute("data-formset-variant")}_getTemplatePack(){return this.targetEl.getAttribute("data-template-pack")}_getModalSize(){return this.targetEl.getAttribute("data-modal-size")}_getModalPlacement(){return this.targetEl.getAttribute("data-modal-placement")}_getModalFormInstanceByRownum(t){let e=!1;return this._modalForms.forEach(function(s){s.rownum===t&&!s.isDeleted()&&(e=s)}),e}_addEvents(){let t=this;this.$formset.on("formAdded",function(e){t._onFormsetAdded(e)}),this.$formset.on("formDeleted",function(e){t._onFormsetDeleted(e)})}_checkInitials(){let t=this,e=[];this.targetEl.querySelectorAll("[data-formset-modal-toggle]").forEach(function(s){let i=s.closest("[data-formset-form]"),r=s.getAttribute("data-formset-modal-toggle");e.includes(r)||t._newModalForm(i,r),e.push(r)})}_newModalForm(t,e){let s=this,i={parent:s,modalId:e,size:s.modalSize,placement:s.modalPlacement,templatePack:s.templatePack,onKeyUp:function(a,l){console.log(a.target),s._onModalFormKeyUp(a,l)},onOpen:function(a){s._onModalFormOpen(a)},onClose:function(a){s._onModalFormClose(a)}},r=new P(t,i);return s._modalForms.push(r),r}_onFormsetAdded(t){if(this.variant===_.modal){let e=b();n(this.targetEl).find("#__dialog_id__").attr("id",e),n(this.targetEl).find('[data-formset-modal-toggle="__dialog_id__"]').attr("data-formset-modal-toggle",e),this._newModalForm(t.target,e).open()}window.hasOwnProperty("calculatedFields")&&(window.resetCalculatedFields(),v())}_onFormsetDeleted(){this.variant==_.modal&&this._refresh(),E()}_onModalFormKeyUp(t,e){}_onModalFormOpen(t){this._refresh()}_onModalFormClose(t){this._refresh()}_configureSelectAllToggler(){let t=this,e=this._table,s=this.targetEl.querySelector(".select-all"),i=this.targetEl.querySelector(".delete-selected");s.addEventListener("change",function(r){let a=s.checked;e.querySelectorAll(".select-row").forEach(function(m){let d=m.closest("tr"),h=m.closest("td"),x=d.querySelector("[data-formset-modal-toggle]").getAttribute("data-formset-modal-toggle"),f=document.getElementById(x).closest("[data-formset-form]");m.checked=a,t._checker(d,h,f,m)})}),i.addEventListener("click",function(r){t.targetEl.querySelectorAll("[data-formset-form-selected]").forEach(function(m){let d=m.querySelector(".formset-delete");d.checked=!0,d.dispatchEvent(new Event("change"))})})}_checkSelectAllState(){let t=this._table,s=this.targetEl.querySelector(".delete-selected"),i=!1,r=t.querySelector(".select-all"),a=t.querySelectorAll("tbody tr").length,l=t.querySelectorAll("tr.selected").length;l===a&&a>0?(r.checked=!0,r.indeterminate=!1,i=!0):(l!=a&&l>0&&(r.indeterminate=!0,r.checked=!1,i=!0),l===0&&(r.checked=!1,r.indeterminate=!1,i=!1)),i?(s.classList.remove("d-none"),s.classList.add("d-inline-flex")):(s.classList.remove("d-inline-flex"),s.classList.add("d-none"))}_checker(t,e,s,i){let r=e.querySelector(".cfm-selection-border");if(r&&r.remove(),i.checked){let a=document.createElement("div");e.classList.add("position-relative"),a.classList.add(...this._options.selectionMarkClasses.split(" ")),e.prepend(a),s.setAttribute("data-formset-form-selected","selected"),t.classList.add("selected")}else i.classList.remove("position-relative"),t.classList.remove("selected"),s.removeAttribute("data-formset-form-selected");this._checkSelectAllState()}_refresh(){let t=this,e={},s=[],i=[];this._table.querySelectorAll("[data-field-name]").forEach(function(a){e[a.getAttribute("data-field-name")]={type:a.getAttribute("data-field-type"),hasSummary:a.hasAttribute("data-field-summary"),summary:0}}),s=Object.keys(e),this._modalForms.forEach(function(a){if(!a.isDeleted()){let l={};a.targetEl.querySelectorAll("input, select").forEach(function(m){let d=m.name.match(/(?<form>\w+)-(?<number>\w+)-(?<name>\w+)/);if(d){let h=d.groups.name;if(s.includes(h)){let u=y(m);l[h]={value:u,sourceId:m.getAttribute("id")},l.modalForm=a}}}),i.push(l)}}),q(this._tbody),i.length===0&&(this._tbody.innerHTML=this._emptyState);let r=1;i.forEach(function(a){a.modalForm.rownum=r;let l=document.createElement("tr");l.classList.add(...t._options.trClasses.split(" ")),l.setAttribute("data-rownum",r),a.modalForm.hasNonFieldError()&&(l.style="border: 1px solid #ff4545");let m=document.createElement("td"),d=document.createElement("input");d.setAttribute("type","checkbox"),d.classList.add(...t._options.checkboxClasses.split(" ")),d.classList.add("select-row"),m.appendChild(d),d.addEventListener("change",function(c){t._checker(l,m,a.modalForm.targetEl,c.target)}),l.appendChild(m);let h=document.createElement("td");h.classList.add(...t._options.tdClasses.split(" ")),h.classList.add("w-10"),h.classList.add("text-right"),h.classList.add("cursor-pointer"),h.innerText=r,h.addEventListener("click",function(){console.log("tdNumber"),a.modalForm.open()}),l.appendChild(h),s.forEach(function(c){let f=document.createElement("td"),A=a.modalForm.hasFieldError(a[c].sourceId);f.classList.add(...t._options.tdClasses.split(" ")),A.error&&(f.style="border: 1px solid #ff4545",f.title=A.text),e[c].type==="bool"?(checked=a[c].value==="on"?"checked":"",f.innerHTML=`<input type="checkbox" class="${t._options.checkboxClasses}" ${checked} disabled></input>`):f.innerText=a[c].value,e[c].type==="numeric"&&(f.classList.add("text-right"),e[c].hasSummary&&(e[c].summary=e[c].summary+M(a[c].value))),(e[c].type==="bool"||e[c].type=="date")&&f.classList.add("text-center"),f.setAttribute("data-source",a[c].sourceId),l.appendChild(f)});let u=document.createElement("td");u.classList.add(...t._options.tdClasses.split(" ")),u.classList.add("w-16"),u.classList.add("text-center"),u.classList.add("p-0"),u.classList.add("align-middle"),u.innerHTML=`
                ...
                </a>`,u.querySelector(".btn-open-row").addEventListener("click",function(c){console.log("button"),a.modalForm.open()}),l.appendChild(u),t._tbody.appendChild(l),a.modalForm.isSelected()&&(d.checked=!0,t._checker(l,m,a.modalForm.targetEl,d)),r++}),this._tfoot&&this._tfoot.querySelectorAll("[data-summary-column]").forEach(function(a){let l=e[a.getAttribute("data-summary-column")].summary;a.innerText=l}),this._checkSelectAllState()}}function H(){document.querySelectorAll(".formset").forEach(function(t){new O(t.getAttribute("id"))})}function j(){let o=[];document.querySelectorAll("[data-modal-toggle]").forEach(t=>{const e=t.getAttribute("data-modal-toggle"),s=document.getElementById(e),i=s.getAttribute("data-modal-placement");s&&!s.hasAttribute("aria-hidden")&&!s.hasAttribute("aria-modal")&&s.setAttribute("aria-hidden","true");let r=null;F(e,o)?(r=F(e,o),r=r.object):(r=new S(s,{placement:i||Default.placement}),o.push({id:e,object:r})),s.hasAttribute("data-modal-show")&&s.getAttribute("data-modal-show")==="true"&&r.show(),t.addEventListener("click",()=>{r.toggle()})})}n.fn[p]=function(){var o,t,e;if(arguments.length===0||arguments.length===1&&n.type(arguments[0])!="string")return o=arguments[0],this.each(function(){return g.getOrCreate(this,o)});if(t=arguments[0],e=n.makeArray(arguments).slice(1),t in g)return e.unshift(this),g[t].apply(g,e);throw new Error("Unknown function call "+t+" for $.fn.formset")},T(function(){I(),j(),v(),H(),E()})})($);
